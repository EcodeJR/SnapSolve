    ...
    return(
        <section className="w-full h-fit overflow-x-hidden text-blackMain">
            <div className="w-full h-fit py-5 lg:h-screen flex items-center justify-center flex-col">
                ...
                <p className="font-bold text-base md:text-lg lg:text-xl text-blackMain/85 font-[Montserrat Alternates] text-center mt-10 lg:mt-0 lg:my-5">Learn and get solutions fast with snapsolve AI, <br /> and focus on other important problems.</p>
                <a href="#" className="text-xl font-semibold my-2 py-3 px-6 shadow-2xl bg-purpleMain text-whiteMain rounded flex items-center justify-center uppercase">Try For Free</a>
            </div>
            <HowItWorks />
            <ThingsToKnow />
            <GetInTouch />
