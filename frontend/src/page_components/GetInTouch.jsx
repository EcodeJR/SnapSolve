    ...
    return ( 
        <section className="w-full py-4 px-3 overflow-hidden">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-evenly p-5">
                <div className="flex flex-col items-start justify-center py-6 px-6 relative">
                    ...
                    <h3 className="text-5xl md:text-6xl font-light pb-10">Talk to the <br /> <span className="flex items-center justify-center font-medium"> Developer<img src={gem_icon} alt="Gemini AI logo" className="w-10 h-fit object-contain animate-spin" /></span></h3>
                    
                    <a href="mailto:emmanueldcode@gamil.com" className="text-lg font-bold text-blackMain/80 uppercase hover:text-purpleMain flex items-center justify-between"><TbMailFast className="text-3xl mx-2" /> emmanueldcode@gmail.com</a>
                    <a href="+2347051242451" className="text-lg font-bold text-blackMain/80 uppercase hover:text-purpleMain flex items-center justify-between"><TbPhoneOutgoing className="text-3xl mx-2" /> +2347051242451</a>
                </div>
